...
<footer class="textcolor">
    <div class="container mx-auto py-8 px-4">
      <div class="grid grid-cols-4 gap-8">
        <!-- Логотип -->
        <div>
          <img src="../assets/logo/logo.svg" alt="Логотип" class="h-8 w-auto scale-150">
        </div>
        ...
        <div>
          ...
          <ul>
            ...
            <li class="my-3"><a href="#">Услуги</a></li>
            <li class="my-3"><a href="#">Контакты</a></li>
          </ul>
        </div>
      ...
      <div class="mt-8 pt-8 border-t-2 flex flex-nowrap justify-between">
        ...
        <div class="flex flex-nowrap gap-5 w-1/3">
          <a href="#" class="">Договор оферты |</a>
